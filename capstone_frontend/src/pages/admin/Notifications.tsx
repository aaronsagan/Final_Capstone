...
import { Bell, Check, CheckCheck, Trash2, TrendingUp, Users, FileText, AlertTriangle, Shield, UserCheck } from "lucide-react";
    ...
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold mb-2 flex items-center gap-2">
          <Bell className="h-6 w-6" /> Admin Notifications
        </h1>
